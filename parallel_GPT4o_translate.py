...
if __name__ == '__main__':
    ...
    for i in range(chunk_num):
        ...
        GPT_Prompt = GPT_Prompt + 'また、中国語に翻訳しなさい、日本語の原文を再度に示さなくてよい'
        ...
        if not DEBUG_MODE:
            ...
            save_string_to_file(output_string, './processed_transcriptions/{}_中文翻译_out.txt'.format(presentation_info_object['name']), mode='a')
        else:
